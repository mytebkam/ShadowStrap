...
namespace ShadowStrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "ShadowStrap-QA";
#else
        public const string ProjectName = "ShadowStrap";
#endif
        public const string ProjectOwner = "ShadowStrap";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructShadowStrapWebUrl();
        ...
        public static string ConstructShadowStrapWebUrl()
        {
