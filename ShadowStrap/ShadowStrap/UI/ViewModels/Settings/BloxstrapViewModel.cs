...
{
    public class ShadowStrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"ShadowStrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "ShadowStrapViewModel::AddFilesToZipStream";
