...
namespace ShadowStrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconShadowStrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconShadowStrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconShadowStrap => Properties.Resources.IconShadowStrap,
                ...
                BootstrapperIcon.IconShadowStrapClassic => Properties.Resources.IconShadowStrapClassic,
                _ => Properties.Resources.IconShadowStrap
            };
        }
    }
}
